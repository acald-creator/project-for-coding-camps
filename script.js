...
function event(e, t, n, r) {
	"add" === e ? window.addEventListener ? t.addEventListener(n, r) : window.attachEvent && t.attachEvent(n, r) : "remove" === e && (window.removeEventListener ? t.removeEventListener(n, r) : window.detachEvent && t.detachEvent(n, r))
}
...
function scrollAbr() {
	...
	function t(e) {
		for (var t, n, r = [], o = 0, a = e.length; a > o;) t = e.charCodeAt(o++), t >= 55296 && 56319 >= t && a > o ? (n = e.charCodeAt(o++), 56320 == (64512 & n) ? r.push(((1023 & t) << 10) + (1023 & n) + 65536) : (r.push(t, n), o--)) : r.push(t);
		return r
	}

	function n(e, t) {
		var n = e && ("[object NodeList]" === Object.prototype.toString.call(e) && e.length || 1 === e.nodeType),
	...
	function o(e, n) {
		var r, o = "value" in e ? e.value : e.innerText || e.textContent;
		return n.stripTags && (o = o.replace(/<\/?[a-z][^>]*>/gi, "")), n.ignoreZeroWidth && (o = o.replace(/[\u200B]+/, "")), r = o.trim(), {
			paragraphs: r ? (r.match(n.hardReturns ? /\n{2,}/g : /\n+/g) || []).length + 1 : 0,
			sentences: r ? (r.match(/[.?!…]+./g) || []).length + 1 : 0,
			words: r ? (r.replace(/['";:,.?¿\-!¡]+/g, "").match(/\S+/g) || []).length : 0,
	...
	var u = {
			...
			var l = r(u),
				s = function(e) {
					...
					c.push({
						element: e,
						handler: n
					}), n(), e.addEventListener ? e.addEventListener(i, n, !1) : e.attachEvent && e.attachEvent("on" + i, n)
				};
			if (n(e, t)) return e.length ? a(e, s) : s(e), this
		},
		die: function(e) {
			return n(e, function() {}) ? (a(e, function(e) {
				var t;
				a(c, function(n) {
					n.element === e && (t = n)
				}), t && (e.removeEventListener ? e.removeEventListener(i, t.handler, !1) : e.detachEvent && e.detachEvent("on" + i, t.handler), c.splice(c.indexOf(t), 1))
			}), this) : void 0
		},
		once: function(e, t, c) {
			return n(e, t) ? (a(e, function(e) {
				t.call(e, o(e, r(c)))
			}), this) : void 0
		},
		...
		enabled: function(e) {
			var t = !1;
			return e && 1 === e.nodeType && a(c, function(n) {
				n.element === e && (t = !0)
			}), t
		}
	};
...
}, 15e3), event("add", window, "scroll", scrollAbr);
var fields = {
